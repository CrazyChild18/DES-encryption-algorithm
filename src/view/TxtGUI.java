...
public class TxtGUI extends JFrame implements ActionListener {
...
//	private String key = "7355608";
    ...
    void init() {
        ...
        menu = new JMenu("File");
        itemSaveContent = new JMenuItem("Save original file");// 初始化菜单项
        itemSaveEncrypt = new JMenuItem("Save encrypted file");// 初始化菜单项
